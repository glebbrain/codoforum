...
<html>
    <head>
        <meta charset="UTF-8">
        <title>CODOFORUM |{_t(' Dashboard')}</title>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="{$active.users}">
                                        <a href="index.php?page=users">
                                            <i class="fa fa-users"></i> <span>{_t('Users')}</span> 
                                        </a>
                                    </li>
                                    <li class="{$active['permission/roles']}">
                                        <a href="index.php?page=permission/roles"><i class="fa fa-key"></i> {_t('Role permissions')}</a>
                                    </li>
                                    ...
                                    <li class="treeview {$active['moderation/ban_user']} {$active['moderation/approve_users']}">
                                        <a href="#">
                                            <i class="fa fa-shield"></i> <span>{_t('Moderation')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li class="{$active['moderation/approve_users']}"> <a href="index.php?page=moderation/approve_users"><i class="fa fa-check"></i><span>{_t(' Approve Users')}</span> </a> </li>                                              
                                            <li class="{$active['moderation/ban_user']}"> <a href="index.php?page=moderation/ban_user"><i class="fa fa-ban"></i><span>{_t(' Ban User')}</span> </a> </li>  
                                        </ul>
                                    </li> 
                                    ...
                                    <li class="treeview {$active['ui/themes']}{$active['ui/blocks']}{$active['ui/smileys']}">
                                        <a href="#">
                                            ...
                                            <span>{_t('UI Elements')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li class="{$active['ui/themes']}"><a href="index.php?page=ui/themes"><i class="fa fa-image"></i>{_t(' Themes')}</a></li>
                                            <li class="{$active['ui/blocks']}"><a href="index.php?page=ui/blocks"><i class="fa fa-cubes"></i>{_t(' Blocks')}</a></li>
                                            <li class="{$active['ui/smileys']}"><a href="index.php?page=ui/smileys"><i class="fa fa-smile-o"></i>{_t(' Smileys')}</a></li>
                                    ...
                                    <li class="treeview {$active['reputation/settings']}">
                                        <a href="#">
                                            ...
                                            <span>{_t('Reputation')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li class="{$active['reputation/settings']}"><a href="index.php?page=reputation/settings"><i class="fa fa-wrench"></i>{_t(' Settings')}</a></li>
                                            <li class="{$active['reputation/promotions']}"><a href="index.php?page=reputation/promotions"><i class="fa fa-level-up"></i>{_t(' Promotions')}</a></li>
                                        </ul>
                                    </li>

                                    <li  class="treeview {$active['mail/configuration']} {$active['mail/templates']}">
                                        <a href="#">
                                            <i class="fa fa-envelope"></i> <span>{_t('Mail Settings')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li  class="{$active['mail/configuration']}"><a href="index.php?page=mail/configuration"><i class="fa fa-gear"></i>{_t(' Configuration')}</a></li>                  
                                            <li  class="{$active['mail/templates']}"><a href="index.php?page=mail/templates"><i class="fa fa-file"></i>{_t(' Templates')}</a></li>
                                    ...
                                    <li  class="treeview {$active['spam/mldetect']} {$active['spam/recaptcha']}">
                                        <a href="#">
                                            <i class="fa fa-archive"></i> <span>{_t('Spam Control')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li  class="{$active['spam/recaptcha']}"><a href="index.php?page=spam/recaptcha"><i class="fa fa-puzzle-piece"></i>{_t(' ReCaptcha')}</a></li>                  
                                            <li  class="{$active['spam/mldetect']}"><a href="index.php?page=spam/mldetect"><i class="fa fa-random"></i>{_t(' Spam detector')}</a></li>
                                    ...
                                    <li class="treeview {$active['system/importer']} {$active['system/cron']} {$active['system/upgrade']} {$active['system/massmail']}">
                                        <a href="#">
                                            <i class="fa fa-desktop"></i> <span>{_t('System')}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li  class="{$active['system/massmail']}"><a href="index.php?page=system/massmail"><i class="fa fa-envelope-square"></i>{_t(' Mass mail')}</a></li>                  
                                            <li  class="{$active['system/cron']}"><a href="index.php?page=system/cron"><i class="fa fa-clock-o"></i>{_t(' Cron')}</a></li>
                                            <li  class="{$active['system/importer']}"><a href="index.php?page=system/importer"><i class="fa fa-exclamation-circle"></i>{_t(' Importer')}</a></li>                  
                                            <li  class="{$active['system/upgrade']}"><a href="index.php?page=system/upgrade"><i class="fa fa-level-up"></i>{_t(' Upgrade')}</a></li>                  
